...
BuildRequires: systemd readline-devel readline
BuildRequires: libselinux-devel perl-Term-ReadLine perl-FindBin
BuildRequires: lmdb-devel fuse-devel perl perl-devel
%ifnarch armv7hl
...
%files
%exclude /usr/sbin/pvfs2-start-all
%exclude /usr/sbin/pvfs2-stop-all
...
/usr/share/man/man5/pvfs2.conf.5.gz
