...
Provides:	pkgconfig(appindicator-0.1)
...
sed -i 's/cd html && gtkdoc-mkhtml/#cd html && gtkdoc-mkhtml/g' docs/reference/Makefile
sed -i 's/gtkdoc-fixxref/#igtkdoc-fixxref/g' docs/reference/Makefile
make -j1 V=1
popd
...
* Mon Apr 13 2020 Eduardo Echeverria <echevemaster@gmail.com> - 12-10-0-28
