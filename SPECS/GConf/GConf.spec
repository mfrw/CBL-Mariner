...
BuildRequires:	intltool libxml2-devel dbus-glib-devel polkit-devel gettext
BuildRequires:  perl
BuildRequires:  perl-generators
BuildRequires:  perl-File-Find

Requires:	libxml2 dbus-glib polkit gettext
%description
...
%{_includedir}/*
%changelog
*	Thu Feb 13 2020 Suresh Babu Chalamalasetty <schalam@microsoft.com> 3.2.5-2
