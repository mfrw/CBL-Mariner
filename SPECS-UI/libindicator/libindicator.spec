...
export CXXFLAGS="%{optflags} -Wno-deprecated-declarations -Wno-error"
...
%changelog
* Tue May 17 2022 Bala <balakumaran.kannan@microsoft.com> - 12.10.1-19
* Update pkgconfig version to 0.4 to 0.4.93 for satisfying lxsession
